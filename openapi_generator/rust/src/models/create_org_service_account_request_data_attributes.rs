...
pub struct CreateOrgServiceAccountRequestDataAttributes {
...
impl CreateOrgServiceAccountRequestDataAttributes {
    pub fn new(auth_type: AuthType, name: String, role_id: uuid::Uuid) -> CreateOrgServiceAccountRequestDataAttributes {
