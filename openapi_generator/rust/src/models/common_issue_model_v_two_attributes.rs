...
pub struct CommonIssueModelVTwoAttributes {
    #[serde(rename = "coordinates", skip_serializing_if = "Option::is_none")]
    pub coordinates: Option<Vec<crate::models::CoordinateVTwo>>,
...
impl CommonIssueModelVTwoAttributes {
    pub fn new() -> CommonIssueModelVTwoAttributes {
